...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('mutual_friend_count'))
        obj.mutualFriendCount = ApiClient.convertToType(data['mutual_friend_count'], 'Number');
   ...
   * @member {Number} mutualFriendCount
   */
  exports.prototype.mutualFriendCount = undefined;
