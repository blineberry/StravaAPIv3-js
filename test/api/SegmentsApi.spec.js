    ...
    describe('SegmentsApi', function() {
      ...
      describe('getLeaderboardBySegmentId', function() {
        it('should call getLeaderboardBySegmentId successfully', function(done) {
          // TODO: uncomment, update parameter values for getLeaderboardBySegmentId call and complete the assertions
          /*
          var id = 789;
          var opts = {};
          opts.gender = "gender_example";
          opts.ageGroup = "ageGroup_example";
          opts.weightClass = "weightClass_example";
          opts.following = true;
          opts.clubId = 789;
          opts.dateRange = "dateRange_example";
          opts.contextEntries = 56;
          opts.page = 56;
          opts.perPage = 30;

          instance.getLeaderboardBySegmentId(id, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(StravaApiV3.SegmentLeaderboard);
            expect(data.entryCount).to.be.a('number');
            expect(data.entryCount).to.be(1993);
            expect(data.effortCount).to.be.a('number');
            expect(data.effortCount).to.be(1993);
            expect(data.komType).to.be.a('string');
            expect(data.komType).to.be("kom");
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(StravaApiV3.SegmentLeaderboardEntry);
                expect(data.athleteName).to.be.a('string');
                expect(data.athleteName).to.be("P. Sagan");
                expect(data.elapsedTime).to.be.a('number');
                expect(data.elapsedTime).to.be(100);
                expect(data.movingTime).to.be.a('number');
                expect(data.movingTime).to.be(80);
