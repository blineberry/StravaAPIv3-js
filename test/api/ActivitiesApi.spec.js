          ...
          instance.getCommentsByActivityId(id, opts, function(error, data, response) {
            ...
            for (let p in dataCtr) {
              ...
              expect(data.athlete).to.be.a(StravaApiV3.SummaryAthlete);
                ...
                expect(data.athlete.friend).to.be.a('string');
                expect(data.athlete.friend).to.be("pending");
                expect(data.athlete.follower).to.be.a('string');
                expect(data.athlete.follower).to.be("pending");
        ...
        it('should call getKudoersByActivityId successfully', function(done) {
          ...
          instance.getKudoersByActivityId(id, opts, function(error, data, response) {
            ...
            for (let p in dataCtr) {
              ...
              expect(data.friend).to.be.a('string');
              expect(data.friend).to.be("pending");
              expect(data.follower).to.be.a('string');
              expect(data.follower).to.be("pending");
