  ...
  describe('(package)', function() {
    describe('SegmentLeaderboard', function() {
      ...
      it('should create an instance of SegmentLeaderboard', function() {
        // TODO: update the code to test SegmentLeaderboard
      ...
      it('should have the property komType (base name: "kom_type")', function() {
        // TODO: update the code to test the property komType
        expect(instance).to.have.property('komType');
        // expect(instance.komType).to.be(expectedValueLiteral);
      });
